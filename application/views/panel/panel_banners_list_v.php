...
<div class="page-content">
    ...
    <!-- Page title -->
        ...
        <h5><i class="fa fa-table"></i> Mini Banners del Home <small>puede ver, editar y eliminar cualquier item.</small></h5>
        <div class="btn-group">
    ...
    <div>
        <a class="btn btn-default" href="<?php echo site_url('panel_banners').'/ins';?>">Agregar Imagen</a>
        <hr>
    </div>
    ...
    <div class="panel panel-default">
                            ...
                            echo '<tr>
                                ...
                                <td>
                                     <div class="table-controls">
                                        <a href="'.site_url('panel_banners').'/upd/'.$item['id'].'" class="btn btn-default btn-icon btn-xs tip" title="Editar"><i class="fa fa-pencil"></i></a>
                                        <a href="'.site_url('panel_banners').'/del/'.$item['id'].'" class="btEliminar btn btn-default btn-icon btn-xs tip" title="Eliminar"><i class="fa fa-times"></i></a>
                                    </div>                            
                                </td>
                            </tr>';
                        }
        ...
        <div class="table-footer">
            <div class="table-actions">
                <form action="<?php echo site_url('panel_banners'); ?>" method="POST">
