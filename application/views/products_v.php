...
<div class="container">
    <div class="row">
        <div class="col-lg-4  logo-linea-parent" id="emg-line-logo">
            <img id="imgemg" src="<?=base_url("media/lineas/emg.jpg")?>"
                 class="logo-linea img-responsive <?php if ($linea == "emg") {
                     echo "logo-linea-active";
                 } ?> " data-linea="emg">
        </div>
        <div class="col-lg-4 logo-linea-parent" id="perfection-line-logo">
            <img id="imgperfection" src="<?=base_url("media/lineas/perfection.jpg")?>"
                 class="logo-linea img-responsive <?php if ($linea == "perfection") {
                     echo "logo-linea-active";
                 } ?> " data-linea="perfection">
        </div>
        <div class="col-lg-4 logo-linea-parent" id="mrc-line-logo">
            <img id="imgmrc" src="<?=base_url("media/lineas/mrc.jpg")?>"
                 class="logo-linea img-responsive <?php if ($linea == "mrc") {
                     echo "logo-linea-active";
                 } ?> " data-linea="mrc">
        </div>
    </div>
...
<div class="row" id="form-products" style="<?php if ($linea != "perfection" && $linea != "mrc" && $linea != "emg") {
    ...
    <div class="container page-producto">
        ...
        <div class=" formulario-productos" style="visibility: hidden;">
            ...
            <form id="formSearchProducts" role="form" method="POST" action="<?php echo site_url('products'); ?>">
                <input type="hidden" name="linea" id="linea" value="<?php if ($linea == "mrc") {
                    echo "mrc";
                }
                if ($linea == "emg") {
                    echo "emg";
                ...
                <div class="col-lg-4 ">
                    ...
                    <div class="form-group">
                        <label class="lblTiposProductos"
                               for="selTiposProductosDownloads"><?php echo lang('field_type_product_1'); ?></label>
                        <div class="input-group">
                            <select class="form-control" id="selTiposProductosDownloads"
                                    name="selTiposProductosDownloads"></select>
                            <span class="input-group-btn">
								<button type="submit" disabled="disabled" id="btSearchProductType"
                                        name="btSearchProductType" value="1" class="btn btn-default"><i
                    ...
                    <div id="sku_changeable" class="form-group">
                        <label class="lblSKU" data-lbl-emg="<?php echo lang('field_sku_emg'); ?>"
                               data-lbl-perfection="<?php echo lang('field_sku_perfection'); ?>"
                               data-lbl-mrc="<?php echo lang('field_sku_mrc'); ?>"
                               for="txtSKU"><?php echo lang('field_sku_gen'); ?></label>
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
								<button type="submit" id="btSearchSKU" name="btSearchSKU" value="1"
                                        class="btn btn-default"><i class="glyphicon glyphicon-search"></i></button>
							</span>
                        </div><!-- /input-group -->
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-btn">
                                <button type="submit" id="btSearchCompetitor" name="btSearchCompetitor"
                                        class="btn btn-default" value="btSearchCompetitor"><i
                                            class="glyphicon glyphicon-search"></i></button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group row text-center" style="margin-top: 300px;">
                    <hr>
                    <button type="submit" id="btReset" name="btReset" class="btn btn-ppal"
                            value="1"><?php echo lang('reset'); ?></button>
                        ...
                        if (isset($item['arrApplicaciones']) and is_array($item['arrApplicaciones'])) { ?>
                            <div class="panel panel-default">
                                <div class="panel-heading"><h6
                                            class="panel-title"><?php echo lang('applications'); ?></h6></div>
