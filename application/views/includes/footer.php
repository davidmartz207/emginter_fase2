          ...
          <div class="row">
               ...
               <div class="col-lg-3">
                    ...
                    <p class="stay_connected">
                        <a href="http://twitter.com" target="_blank" title="Twitter"><i class="fa fa-twitter"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="http://facebook.com" target="_blank" title="Facebook"><i class="fa fa-facebook"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="#" target="_blank" title="Vimeo"><i class="fa fa-vimeo-square"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="#" target="_blank" title="Skype"><i class="fa fa-skype"></i></a> 
                        &nbsp;&nbsp;&nbsp;
                        <a href="http://youtube.com" target="_blank" title="Youtube"><i class="fa fa-youtube-square"></i></a>
                    </p>
               </div>
          </div>
     </div>
    ...
    $(document).ready(function(){
      ...
      // echo (isset($selTiposProductosDownloads) ? $selTiposProductosDownloads : 0); 
        if(in_array(get_controller(),array('products'))){ ?>
            $("#selTiposProductosDownloads").jCombo("<?php echo site_url('products'); ?>/get_json_all_products_type",{
