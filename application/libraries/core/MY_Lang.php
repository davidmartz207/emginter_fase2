	...
	***************************************************/
	...
	function __construct()
	{
		...
		global $RTR;
                ...
                # --------- COMPATIBILIDAD PLUGIN MEDIA(IMAGENES) --------------
                $segment_0 = $URI->segment(0);
                # --------- END COMPATIBILIDAD PLUGIN MEDIA(IMAGENES) ----------
		...
		else if($this->is_special($segment)) // special URI -> no redirect
		{
			return;
                ...
                # --------- COMPATIBILIDAD PLUGIN MEDIA(IMAGENES) --------------
                # valdiacion agregada para evitar compatibilidad 
                # entre plugin media(imagenes) y lang
                else if($segment_0=='media' or $segment=='media')
		{
			return;#media -> no redirect
		}
                # --------- END COMPATIBILIDAD PLUGIN MEDIA(IMAGENES) ----------
