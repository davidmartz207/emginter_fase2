...
<meta name="description" content="<?php echo ((isset($meta_descripcion) and !empty($meta_descripcion)) ? $meta_descripcion." - EMG International" : 'EMG International'); ?>" />
<meta name="keywords" content="<?php echo ((isset($meta_keywords) and !empty($meta_keywords)) ? $meta_keywords.', Engine, Manufacture, Emginter' : 'Engine, Manufacture, Emginter'); ?>" />
<?php
#canonical
