    ...
    <div class="row">
        <div class="col-lg-12">
            <?php
             ...
             echo '<br>';
             echo form_open_multipart('panel_usuarios/ins','role="form" class="form-horizontal form-bordered"');
             ?>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title">Crear usuario</h6>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="selEstatus">Estatus Inicial:</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-actions text-right">
                            <input type="submit" name="btSubmit" class="btn btn-primary" value="Crear Usuario">
                        </div>
                    </div>
                </div>
            </form>
