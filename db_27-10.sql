...
CREATE TABLE IF NOT EXISTS idiomas(
  id_idioma INT(4) AUTO_INCREMENT PRIMARY KEY,
  nombre VARCHAR(255),
  lang VARCHAR(2),
...
INSERT INTO idiomas(nombre,lang) VALUES('Not applicable','');
INSERT INTO idiomas(nombre,lang) VALUES('Ingles','en');
INSERT INTO idiomas(nombre,lang) VALUES('Español','es');

CREATE TABLE IF NOT EXISTS tipos_usuarios(
  id_tipo_usuario INT(4) AUTO_INCREMENT PRIMARY KEY,
  nombre VARCHAR(25),
...
INSERT INTO tipos_usuarios(nombre, descripcion) VALUES
('Administrador', 'Usuario de nivel 1 - Todos los privilegios'),
('Editor', 'Usuario de nivel 2 - Privilegios restringidos'),
('Usuario Básico', 'Usuario de nivel 3 - Sin privilegios'),
('Representante', 'Usuario de nivel 2 - Privilegios sobre pedidos');
...
CREATE TABLE IF NOT EXISTS usuarios(
  ...
  fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  estatus TINYINT(1) DEFAULT '1',
  FOREIGN KEY (id_tipo_usuario) REFERENCES tipos_usuarios(id_tipo_usuario) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- pass: i2web123
INSERT INTO usuarios (id_tipo_usuario,nombre,apellido, email, password) VALUES
(1, 'i2web','Admin','administrador@host.com', '4084105e8ab5374629848b101c3ced713b4889aa'),
(1, 'Webmaster','Admin', 'webmaster@host.com', '4084105e8ab5374629848b101c3ced713b4889aa'),
(1, 'Bart','Stifano', 'bstifano@gmail.com', '4084105e8ab5374629848b101c3ced713b4889aa'),
(4, 'Jon','Doe', 'representante@host.com', '4084105e8ab5374629848b101c3ced713b4889aa');
...
CREATE TABLE IF NOT EXISTS items_x_order(
...
CREATE TABLE configuraciones(
    ...
    num_row_table INT DEFAULT 20,
    telefono VARCHAR(255),
    fax VARCHAR(255),
    email_contact VARCHAR(255),
    email_public VARCHAR(255),
    direccion TEXT,
    horarios_jornada_laboral VARCHAR(255),
    mensaje_registro TEXT,
    mensaje_registro_aprobacion TEXT,
    texto_productos TEXT,
    texto_guia_productos TEXT,
    texto_contacto TEXT,
    fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    estatus TINYINT(1) DEFAULT '1',
...
INSERT INTO configuraciones(id_idioma,num_row_table,telefono,fax,email_contact,email_public,direccion,mensaje_registro,mensaje_registro_aprobacion) 
VALUES (2,20,'305.594.7111','305.594.7111','contact@emginter.com','sales@emginter.com','5220 NW 72 Ave Suite 28 Miami, FL 33166'
,'Thank you for registering at EMG International. You will receive a confirmation email once your account has been approved.'
,'Your account at EMG International has been activated. You can login at any time using your username and password.');

INSERT INTO configuraciones(id_idioma,num_row_table,telefono,fax,email_contact,email_public,direccion,mensaje_registro,mensaje_registro_aprobacion) 
VALUES (3,20,'305.594.7111','305.594.7111','contact@emginter.com','sales@emginter.com','5220 NW 72 Ave Suite 28 Miami, FL 33166'
,'Gracias por registrarse en EMG International. Una vez aprobada su cuenta recibirá un correo electrónico de confirmación.'
,'Su cuenta en EMG International ha sido aprobada. Usted puede hacer login en cualquier momento usando su usuario y clave.');

CREATE TABLE galeria_global(
...
INSERT INTO galeria_global (id_idioma,nombre,path_img) VALUES (1,'header1','header-1.jpg');
INSERT INTO galeria_global (id_idioma,nombre,path_img) VALUES (1,'header2','header-2.jpg');
INSERT INTO galeria_global (id_idioma,nombre,path_img) VALUES (1,'header3','header-3.jpg');

CREATE TABLE image_link(
  id_image_link INT AUTO_INCREMENT PRIMARY KEY,
  id_idioma INT NOT NULL,
  nombre VARCHAR(255),
  path_img VARCHAR(255),
  enlace VARCHAR(255),
...
INSERT INTO image_link (id_idioma,nombre,path_img,enlace) VALUES (2,'Banner Catalogo Ingles','banner-catalogo-en.jpg','products');
INSERT INTO image_link (id_idioma,nombre,path_img,enlace) VALUES (3,'Banner Catalogo Español','banner-catalogo-es.jpg','products');
INSERT INTO image_link (id_idioma,nombre,path_img,enlace) VALUES (2,'Banner Registrese Ingles','banner-registrese-en.jpg','register');
INSERT INTO image_link (id_idioma,nombre,path_img,enlace) VALUES (3,'Banner Registrese Español','banner-registrese-es.jpg','register');
INSERT INTO image_link (id_idioma,nombre,path_img,enlace) VALUES (2,'Banner Download Catalog Ingles','banner-download-catalog-en.png','downloads');
INSERT INTO image_link (id_idioma,nombre,path_img,enlace) VALUES (3,'Banner Download Catalog Español','banner-download-catalog-es.png','downloads');

CREATE TABLE IF NOT EXISTS tipos_contenidos(
  id_tipo_contenido INT(11) AUTO_INCREMENT PRIMARY KEY,
  nombre VARCHAR(255),
  fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  estatus TINYINT(1) DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO tipos_contenidos(nombre) VALUES
('Texto Home / Texto de la página de Inicio'),
('Nosotros / About us');

CREATE TABLE IF NOT EXISTS contenidos(
  id_contenido INT(11) AUTO_INCREMENT PRIMARY KEY,
  ...
  fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  estatus TINYINT(1) DEFAULT '1',
  FOREIGN KEY(id_tipo_contenido) REFERENCES tipos_contenidos(id_tipo_contenido) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY(id_usuario) REFERENCES usuarios(id_usuario) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO contenidos(id_tipo_contenido,id_usuario,url_post,titulo_en,contenido_en,titulo_es,contenido_es,path_img) VALUES
(1,1,'emg-international','EMG INTERNATIONAL',"We are a leading distributor of products as injection sensor and engine management system for Asians, Europeans and Americans vehicles. With a large experience in the market, we offer a large quantity of high quality products, which meet or exceed the original manufacturer’s specifications. Because at EMG International our customer and your satisfaction is our #1 goal.",'EMG INTERNATIONAL',"Somos el distribuidor líder en componentes de control de inyección y gestión del motor para vehículos asiáticos, europeos y estadounidenses. Con vasta experiencia en el mercado, ofrecemos una amplia cantidad de productos de altísima calidad, diseñados y elaborados para cumplir con las más altas exigencias, que igualan o mejoran las especificaciones del fabricante original. Porque en EMG International nuestros clientes y su satisfacción es nuestra meta # 1.",'emg.jpg'),
(2,1,'about-us','ABOUT US',"As a leading distributor in products such as sensors of the injection and engine management system, EMG International has earned a reputation as a supplier of quality proven components, in the aftermarket that exceeds all expectations. Our years of experience in the injection and engine management business and our ability to work closely with our partners enable us to ensure that we produce a quality product at a competitive price. These products are designed and manufactured to meet your needs. Our team is working continuously in research and development to ensure we are offering our customers some of the best products in the industry. With perfect form fit and function demanded by today's technicians for Asians, Europeans and Americans vehicles. We ensure that our sensors can meet or exceed the original manufacturer's specifications at peak operating performance and provides longer life. At EMG International our customers and your satisfaction is our # 1 goal and all our staff works tirelessly to ensure that every day we are offering our customers responsible,competent and excellent service.",'SOBRE NOSOTROS',"Como distribuidor líder en productos tales como sensores de inyección y sistemas de gestión del motor, EMG International ha ganado una reputación como proveedor de calidad en el mercado de accesorios, ofreciendo componentes comprobados y que superan todas sus expectativas. Nuestros años de experiencia en el negocio de inyección y gestión electrónica del motor y nuestra capacidad de trabajar en estrecha colaboración con nuestros socios, nos permite asegurar el poderles brindar un producto de calidad a un precio competitivo. Estos productos están diseñados y fabricados para satisfacer sus necesidades. Nuestro equipo está trabajando continuamente en investigación y desarrollo para asegurar que estamos ofreciendo a nuestros clientes los mejores productos de la industria, ofreciendo diseños cuidados a la perfección que funcionan acorde a las rigurosas exigencias de los técnicos de hoy en día para vehículos asiáticos, europeos y estadounidenses. Nos aseguramos de que nuestros sensores pueden igualar o mejorar las especificaciones del fabricante original en el desempeño operativo máximo y proporcionando una mayor vida útil. En EMG International nuestros clientes y su satisfacción es nuestra meta # 1 y todo nuestro personal trabaja sin descanso para asegurar que todos los días estamos ofreciendo a nuestros clientes un servicio responsable, competente y excelente.",'about_us.jpg');
...
INSERT INTO marcas (nombre) VALUES('Buick');
INSERT INTO marcas (nombre) VALUES('Chevrolet');
INSERT INTO marcas (nombre) VALUES('GMC');
INSERT INTO marcas (nombre) VALUES('Saturn');
INSERT INTO marcas (nombre) VALUES('Pontiac');
INSERT INTO marcas (nombre) VALUES('Hummer');
INSERT INTO marcas (nombre) VALUES('SAAB');

CREATE TABLE IF NOT EXISTS modelos(
  id_modelo INT(11) AUTO_INCREMENT PRIMARY KEY,
...
INSERT INTO modelos (id_marca,nombre) VALUES(1,'ucerne');
INSERT INTO modelos (id_marca,nombre) VALUES(1,'Rendezvous');
INSERT INTO modelos (id_marca,nombre) VALUES(1,'Terraza');
INSERT INTO modelos (id_marca,nombre) VALUES(2,'Equinox');
INSERT INTO modelos (id_marca,nombre) VALUES(2,'Express 1500');
INSERT INTO modelos (id_marca,nombre) VALUES(2,'Impala');
INSERT INTO modelos (id_marca,nombre) VALUES(2,'alibu');

CREATE TABLE IF NOT EXISTS tipos_motores(
  id_tipo_motor INT(11) AUTO_INCREMENT PRIMARY KEY,
  nombre_en VARCHAR(255),
  nombre_es VARCHAR(255),
  fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  estatus TINYINT(1) DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO tipos_motores (nombre_en) VALUES('All');
INSERT INTO tipos_motores (nombre_en) VALUES('1.2 Diesel');
INSERT INTO tipos_motores (nombre_en) VALUES('1.2 Gas');
INSERT INTO tipos_motores (nombre_en) VALUES('L4-1.0L');
INSERT INTO tipos_motores (nombre_en) VALUES('L4-1.6L');
INSERT INTO tipos_motores (nombre_en) VALUES('L4-1.8L');
INSERT INTO tipos_motores (nombre_en) VALUES('L4-2.0L');
INSERT INTO tipos_motores (nombre_en) VALUES('L5-2.5L');
INSERT INTO tipos_motores (nombre_en) VALUES('V6-3.4L');

CREATE TABLE IF NOT EXISTS tipos_productos(
  id_tipo_producto INT(11) AUTO_INCREMENT PRIMARY KEY,
  nombre_en VARCHAR(255),
  nombre_es VARCHAR(255),
  fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  estatus TINYINT(1) DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Camshaft Position Sensor','Sensor de Posición del Arbol de Levas');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Crankshaft Position Sensor','Sensor de Posición del Cigüeñal');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Engine Coolant Temperature Sensor','Sensor de Temperatura de Refrigerante');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Fuel Pressure Regulator','Regulador de Presión de Combustible');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Idle Air Control Valve','Válvula de Control de Aire en Marcha Mínima');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Ignition Coil','Bobina de Encendido');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Knock Detonation Sensor','Sensor de Detonación');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Manifold Air Pressure Sensor','Sensor de Presión de Aire del Colector');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Mass Air Flow Sensor','Sensor del Flujo de Masa de Aire');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Oil Pressure Switch','Sensor de Presión de Aceite');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('Temperature Sending Unit','Sensor de Temperatura');
INSERT INTO tipos_productos (nombre_en,nombre_es) VALUES('hrottle Position Sensor','Sensor de Posición del Acelerador');
...
CREATE TABLE IF NOT EXISTS productos(
  ...
  fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  estatus TINYINT(1) DEFAULT '1',
  FOREIGN KEY (id_tipo_producto) REFERENCES tipos_productos(id_tipo_producto) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS aplicaciones_productos(
  id_aplicaciones_producto INT(11) AUTO_INCREMENT PRIMARY KEY,
  id_producto INT NOT NULL,
  id_marca INT NOT NULL,
  id_tipo_motor INT NOT NULL,
  ref_id_modelo INT DEFAULT 0,
  years VARCHAR(255),
  fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  estatus TINYINT(1) DEFAULT '1',
  FOREIGN KEY (id_producto) REFERENCES productos(id_producto) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (id_marca) REFERENCES marcas(id_marca) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (id_tipo_motor) REFERENCES tipos_motores(id_tipo_motor) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS catalogos_productos(
  id_catalogo INT(11) AUTO_INCREMENT PRIMARY KEY,
  nombre_en VARCHAR(255) NOT NULL,
  nombre_es VARCHAR(255) NOT NULL,
  ruta_interna VARCHAR(255),
  ruta_externa VARCHAR(255),
  path_img VARCHAR(255),
  fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  estatus TINYINT(1) DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO catalogos_productos(nombre_en,nombre_es,ruta_interna,path_img) 
VALUES("Sensor's Catalog","Catálogo de Sensores",'catalogo.pdf','imagen.jpg');
INSERT INTO catalogos_productos(nombre_en,nombre_es,ruta_interna,path_img) 
VALUES("Coli's Catalog","Catálogo de Bobinas",'catalogo.pdf','imagen.jpg');