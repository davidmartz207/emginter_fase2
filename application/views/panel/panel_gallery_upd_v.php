    ...
    <div class="row">
        <div class="col-lg-12">
            <?php
             ...
             echo '<br>';
             echo form_open_multipart('panel_gallery/upd/'.$id,'role="form" class="form-horizontal form-bordered"');
             ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="col-lg-7">
                                <img src="<?php echo image('media/top_gallery/'.$id.'/'.$imagen_actual, 'publi_image'); ?>" />
                            </div>
                            <div class="col-lg-5">
