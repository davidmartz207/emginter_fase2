...
<div class="page-content">
    ...
    <!-- Page title -->
        ...
        <h5><i class="fa fa-archive"></i> Modelos <small></small></h5>
        <div class="btn-group">
        </div>
    </div>
    <!-- /page title -->
    ...
    <div class="row">
        <div class="col-lg-12">
            <?php
             ...
             echo '<br>';
             echo form_open_multipart('panel_model/upd/'.$id,'role="form" class="form-horizontal form-bordered"');
             ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                            <label class="col-sm-2 control-label" for="selMarcas">Marca:<span class="asterisco_rojo">*</span></label>
                            <div class="col-sm-10">
                                <select id="selMarcas" name="selMarcas" class="form-control">
                                    <?php 
                                    //echo "<pre>",print_r($arrIdiomas),"</pre>";
                                    if(isset($arrMarcas) and is_array($arrMarcas)){
                                        echo '<option value="">-- Seleccione --</option>';
                                        foreach($arrMarcas as $item){
                                            $selected = $selMarcas == $item['id'] ? 'selected="selected"' : '';
