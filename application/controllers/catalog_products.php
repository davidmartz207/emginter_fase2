...
class Catalog_products extends CI_Controller{
    ...
    public function index(){
        ...
        if($this->input->post('btSearchPpal') or $SESS_searcht=='btSearchPpal'){
            ...
            $arrParam['linea'] = $this->arrDatos['linea'];
        ...
        if(!empty($type)){
            ...
            $config['base_url']            = site_url('catalog_products').'/index/';
    ...
    public function get_json_marcas(){
        ...
        echo $this->modelo->get_json_marcas($year,$linea);
    }
    public function get_json_modelos(){
        ...
        echo $this->modelo->get_json_modelos($year,$id_marca,$linea);
    }
    public function get_json_tipos_motores(){
        ...
        echo $this->modelo->get_json_tipos_motores($year,$id_marca,$id_modelo,$linea);
    }
    ...
    public function get_json_tipos_productos(){
        ...
        echo $this->modelo->get_json_tipos_productos($year,$id_marca,$id_modelo,$id_tipo_motor,$linea);
    }
