...
<div class="page-content">
    ...
    <!-- Page title -->
        ...
        <h5><i class="fa fa-table"></i> Noticias <small>puede ver, editar y eliminar cualquier item.</small></h5>
        <div class="btn-group">
    ...
    <div>
        <a class="btn btn-default" href="<?php echo site_url('panel_news').'/ins';?>">Agregar</a>
        <hr>
    </div>
    ...
    <div class="panel panel-default">
                    ...
                    if($flag){
                        ...
                        foreach($arrResult as $item){
                            echo '<tr>
                                ...
                                <td>'.$item['titulo_es'].'</td>
                                <td>'.$item['estatus'].'</td>
                                <td>
                                    <div class="table-controls">
                                        <a href="'.site_url('panel_news').'/upd/'.$item['id'].'" class="btn btn-default btn-icon btn-xs tip" title="Editar"><i class="fa fa-pencil"></i></a>
                                        <a href="'.site_url('panel_news').'/del/'.$item['id'].'" class="btEliminar btn btn-default btn-icon btn-xs tip" title="Eliminar"><i class="fa fa-times"></i></a>
                                    </div>                            
                                </td>
                            </tr>';
                        }
        ...
        <div class="table-footer">
            <div class="table-actions">
                <form action="<?php echo site_url('panel_news'); ?>" method="POST">
                    <select name="selOrderBy" class="select-liquid">
                        <option value="">Ordenar por</option>
                        <option value="1">ID</option>
                        <option value="2">Título Inglés</option>
                        <option value="3">Título Español</option>
